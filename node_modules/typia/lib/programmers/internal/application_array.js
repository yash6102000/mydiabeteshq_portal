    ...
    return function (components) {
        return function (array) {
            return function (attribute) {
                var items = (0, application_schema_1.application_schema)(options)(false)(components)(array.type.value)(attribute);
                var base = __assign(__assign({}, attribute), { type: "array", items: null });
...
var application_array_tags = function (schema) {
    return function (row) {
        var e_1, _a;
        try {
