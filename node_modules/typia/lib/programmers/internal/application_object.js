            ...
            return function (nullable) {
                ...
                var _loop_1 = function (property) {
                    ...
                    var schema_1 = (0, application_schema_1.application_schema)(options)(true)(components)(property.value)({
                        ...
                        description: (_d = property.description) !== null && _d !== void 0 ? _d : undefined,
                    ...
                    if (schema_1 === null)
                        ...
                        if (pattern === PatternUtil_1.PatternUtil.STRING)
                            ...
                            extraMeta.patternProperties[pattern] = [property.value, schema_1];
                    }
                };
                try {
                    for (var _f = __values(obj.properties), _g = _f.next(); !_g.done; _g = _f.next()) {
                ...
                var extraProps = {
                    additionalProperties: (_e = extraMeta.additionalProperties) === null || _e === void 0 ? void 0 : _e[1],
